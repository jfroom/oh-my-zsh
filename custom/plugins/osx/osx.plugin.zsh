...
sudo scutil --set ComputerName "JFMK Macbook"
sudo scutil --set HostName "JFMK Macbook"
sudo scutil --set LocalHostName "JFMK-Macbook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "JFMK Macbook"
...
systemsetup -settimezone "US/Chicago" > /dev/null
